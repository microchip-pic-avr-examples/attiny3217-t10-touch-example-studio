...
#define NODE_0_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(5), Y(3), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_8), NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16          \
	}
#define NODE_1_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(4), Y(3), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_8), NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16          \
	}
#define NODE_2_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(1), Y(3), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_8), NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16          \
	}
#define NODE_3_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(0), Y(3), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_8), NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16          \
	}
#define NODE_4_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(5), Y(2), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_8), NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16          \
	}
#define NODE_5_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(4), Y(2), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_8), NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16          \
	}
#define NODE_6_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(1), Y(2), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_8), NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16          \
	}
#define NODE_7_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(0), Y(2), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_8), NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16          \
	}
